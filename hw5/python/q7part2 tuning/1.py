...
valid_dataset_loader = torch.utils.data.DataLoader(valid_dataset, shuffle=False, batch_size=valid_dataset_size)
...
optimizer_classifier = torch.optim.SGD(model.classifier.parameters(), lr=learning_rate_classifier, weight_decay=1e-5, nesterov=True, momentum=0.9)
optimizer_features = torch.optim.SGD(model.features.parameters(), lr=learning_rate_features, weight_decay=1e-5, nesterov=True, momentum=0.9)
# optimizer_classifier = torch.optim.SGD(model.classifier.parameters(), lr=learning_rate_classifier, nesterov=True, momentum=0.9)
# optimizer_features = torch.optim.SGD(model.features.parameters(), lr=learning_rate_features, nesterov=True, momentum=0.9)
